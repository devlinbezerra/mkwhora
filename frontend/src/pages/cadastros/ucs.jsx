...
export default function CadastroAgencia() {
  const fields = [
    ...
    { name: 'optante_bt', label: 'É Optante BT', type: 'boolean', required: true },
    { name: 'tipo_ligacao', label: 'Tipo de Ligação', type: 'text', required: true },
    { name: 'tensao', label: 'Tensão', type: 'text', required: true },
    { name: 'consumidor', label: 'Cliente', type: 'text', required: true },
    ...
    { name: 'desagio', label: 'Deságio', type: 'text', required: true },
    { name: 'autoconsumo_remoto', label: 'É autoconsumo remoto?', type: 'text', required: true }
  ];
